...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Notify Author that Article is due for review with time trigger</fullName>
        <active>true</active>
        <criteriaItems>
            <field>BMCServiceDesk__KM_KnowledgeArticle__c.BMCServiceDesk__Status__c</field>
            <operation>equals</operation>
        ...
        <workflowTimeTriggers>
            <offsetFromField>BMCServiceDesk__KM_KnowledgeArticle__c.BMCServiceDesk__Review_Date__c</offsetFromField>
